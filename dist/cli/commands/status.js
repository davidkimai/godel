...
async function gatherSystemStatus() {
    ...
    // Get budget info
    const budgetCount = budget_1.activeBudgets.size;
    const budgetArray = Array.from(budget_1.activeBudgets.values());
 ...
 */
function checkOpenClawConnectionFast() {
 ...
 */
async function checkOpenClawConnection() {
 ...
 */
function determineSystemHealth(agents, swarms, openclaw) {
 ...
 */
function determineSystemHealthFromCounts(agentCounts, swarmCount, openclaw) {
...
exports.default = registerStatusCommand;
