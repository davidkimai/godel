...
export interface AgentEvent extends BaseEvent {
    eventType: 'agent.spawned' | 'agent.status_changed' | 'agent.completed' | 'agent.failed' | 'agent.blocked' | 'agent.paused' | 'agent.resumed' | 'agent.killed';
    payload: AgentSpawnedPayload | AgentStatusChangedPayload | AgentCompletedPayload | AgentFailedPayload;
}
...
export interface TaskEvent extends BaseEvent {
    eventType: 'task.created' | 'task.status_changed' | 'task.assigned' | 'task.completed' | 'task.blocked' | 'task.failed' | 'task.cancelled';
    payload: TaskCreatedPayload | TaskStatusChangedPayload | TaskCompletedPayload;
}
...
export interface ContextEvent extends BaseEvent {
    eventType: 'context.added' | 'context.removed' | 'context.changed' | 'context.snapshot';
    payload: ContextAddedPayload | ContextRemovedPayload | ContextChangedPayload | ContextSnapshotPayload;
}
...
export interface QualityEvent extends BaseEvent {
    eventType: 'critique.requested' | 'critique.completed' | 'critique.failed' | 'quality.gate_passed' | 'quality.gate_failed';
    payload: CritiqueRequestedPayload | CritiqueCompletedPayload | QualityGatePayload;
}
...
export interface TestEvent extends BaseEvent {
    eventType: 'test.started' | 'test.completed' | 'test.failed' | 'test.coverage';
    payload: TestStartedPayload | TestCompletedPayload | TestCoveragePayload;
}
...
export interface ReasoningEvent extends BaseEvent {
    eventType: 'reasoning.trace' | 'reasoning.decision' | 'reasoning.confidence_changed';
    payload: ReasoningTracePayload | ReasoningDecisionPayload | ReasoningConfidencePayload;
}
...
export interface SafetyEvent extends BaseEvent {
    eventType: 'safety.violation_attempted' | 'safety.boundary_crossed' | 'safety.escalation_required' | 'safety.human_approval';
    payload: SafetyViolationPayload | SafetyBoundaryPayload | SafetyEscalationPayload | SafetyHumanApprovalPayload;
}
...
export interface SystemEvent extends BaseEvent {
    eventType: 'system.bottleneck_detected' | 'system.disconnected' | 'system.emergency_stop' | 'system.checkpoint';
    payload: SystemBottleneckPayload | SystemDisconnectedPayload | SystemCheckpointPayload | {
        reason: string;
    };
}
export type MissionEvent = AgentEvent | TaskEvent | ContextEvent | QualityEvent | TestEvent | ReasoningEvent | SafetyEvent | SystemEvent;
...
export declare function createBaseEvent(eventType: EventType, source: BaseEvent['source'], correlationId?: string): Omit<BaseEvent, 'id' | 'timestamp'>;
