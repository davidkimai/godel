...
exports.PERMISSIVE_INHERITANCE_OPTIONS = exports.STRICT_INHERITANCE_OPTIONS = exports.DEFAULT_INHERITANCE_OPTIONS = exports.SECURITY_PROFILES = exports.GENEROUS_RESOURCE_LIMITS = exports.RESTRICTED_RESOURCE_LIMITS = exports.DEFAULT_RESOURCE_LIMITS = exports.PERMISSIVE_DOCKER_CONFIG = exports.RESTRICTED_DOCKER_CONFIG = exports.DEFAULT_DOCKER_CONFIG = exports.READONLY_PERMISSIONS = exports.FULL_PERMISSIONS = exports.RESTRICTED_PERMISSIONS = exports.DEFAULT_PERMISSIONS = exports.SAFE_TOOLS = exports.SESSION_TOOLS = exports.NETWORK_TOOLS = exports.FILE_TOOLS = exports.DANGEROUS_TOOLS = exports.ALL_TOOLS = void 0;
exports.validatePermissions = validatePermissions;
exports.isValidSandboxMode = isValidSandboxMode;
exports.computeInheritedPermissions = computeInheritedPermissions;
// ============================================================================
// Tool Categories
// ============================================================================
 ...
 */
exports.RESTRICTED_PERMISSIONS = {
    allowedTools: ['read', 'web_search', 'web_fetch', 'image', 'tts'],
    deniedTools: [...exports.DANGEROUS_TOOLS, ...exports.SESSION_TOOLS],
    sandboxMode: 'docker',
 ...
 */
exports.READONLY_PERMISSIONS = {
    allowedTools: ['read', 'web_search', 'web_fetch', 'image', 'sessions_list', 'sessions_history'],
    deniedTools: [...exports.FILE_TOOLS.filter(t => t !== 'read'), ...exports.DANGEROUS_TOOLS],
    sandboxMode: 'non-main',
 ...
 */
exports.RESTRICTED_DOCKER_CONFIG = {
 ...
 */
exports.PERMISSIVE_DOCKER_CONFIG = {
 ...
 */
exports.RESTRICTED_RESOURCE_LIMITS = {
 ...
 */
exports.GENEROUS_RESOURCE_LIMITS = {
...
exports.SECURITY_PROFILES = {
    ...
    standard: {
        ...
        permissions: exports.DEFAULT_PERMISSIONS,
        sandboxConfig: exports.DEFAULT_DOCKER_CONFIG,
    ...
    untrusted: {
        ...
        permissions: exports.RESTRICTED_PERMISSIONS,
        sandboxConfig: exports.RESTRICTED_DOCKER_CONFIG,
    ...
    analysis: {
        ...
        permissions: exports.READONLY_PERMISSIONS,
        sandboxConfig: {
            ...exports.DEFAULT_DOCKER_CONFIG,
 ...
 */
exports.DEFAULT_INHERITANCE_OPTIONS = {
 ...
 */
exports.STRICT_INHERITANCE_OPTIONS = {
 ...
 */
exports.PERMISSIVE_INHERITANCE_OPTIONS = {
    inheritPermissions: true,
...
function validatePermissions(permissions) {
    ...
    const conflicts = permissions.allowedTools.filter(t => permissions.deniedTools.includes(t));
 ...
 */
function computeInheritedPermissions(parentPermissions, childPermissions = {}, options = exports.DEFAULT_INHERITANCE_OPTIONS) {
    ...
    const basePermissions = options.restrictChildPermissions
        ? parentPermissions
        : { ...exports.DEFAULT_PERMISSIONS, ...parentPermissions };
