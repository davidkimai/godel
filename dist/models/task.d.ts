 ...
 */
export type QualityDimension = 'correctness' | 'completeness' | 'consistency' | 'clarity' | 'performance' | 'security' | 'style' | 'type_safety' | 'test_coverage';
/**
 ...
 */
export declare function createQualityGate(criteria: QualityCriterion[], passingThreshold?: number): QualityGate;
/**
 ...
 */
export declare function createQualityCriterion(dimension: QualityDimension, weight: number, threshold?: number): QualityCriterion;
