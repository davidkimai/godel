...
exports.DEFAULT_GATES = void 0;
exports.calculateScore = calculateScore;
exports.calculateLintScore = calculateLintScore;
exports.calculateTypeScore = calculateTypeScore;
exports.calculateCoverageScore = calculateCoverageScore;
exports.calculatePassRateScore = calculatePassRateScore;
exports.calculateSecurityScore = calculateSecurityScore;
exports.evaluateQualityGate = evaluateQualityGate;
exports.generateLintSummary = generateLintSummary;
exports.parseCriteriaJson = parseCriteriaJson;
exports.createGateFromCriteria = createGateFromCriteria;
 ...
 */
function calculateLintScore(results) {
    let totalErrors = 0;
    let totalWarnings = 0;
 ...
 */
function calculateTypeScore(errors, warnings) {
...
function calculateCoverageScore(coverage) {
    if (coverage >= 80)
        return 1.0;
    if (coverage >= 60)
        return 0.6 + (coverage - 60) * 0.02;
    if (coverage >= 40)
        return 0.4 + (coverage - 40) * 0.01;
    ...
    for (const criterion of gate.criteria) {
        ...
        switch (criterion.dimension) {
            ...
            case 'performance': {
                ...
                const perfIssues = lintResults?.flatMap(r => r.issues.filter(i => i.category === 'performance')).length ?? 0;
            ...
            case 'security': {
                ...
                if (secVulns) {
                    ...
                    const secIssues = lintResults?.flatMap(r => r.issues.filter(i => i.category === 'security')).length ?? 0;
 ...
 */
function calculateOverallScore(criterionScores) {
 ...
 */
function generateLintSummary(results) {
    const aggregate = {
        errors: 0,
        warnings: 0,
        hints: 0,
...
function parseCriteriaJson(criteriaJson) {
    try {
 ...
 */
function createGateFromCriteria(criteriaJson, options = {}) {
 ...
 */
function formatGateResult(result, options) {
