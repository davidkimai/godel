 ...
 */
export * from './types';
export { UnifiedSkillRegistry, getGlobalSkillRegistry, resetGlobalSkillRegistry, } from './registry';
export { ClawHubAdapter, getGlobalClawHubAdapter, resetGlobalClawHubAdapter, } from './clawhub';
export { VercelSkillsClient, getGlobalVercelSkillsClient, resetGlobalVercelSkillsClient, } from './vercel';
import { UnifiedSkillRegistry } from './registry';
import { UnifiedSkillMetadata, UnifiedSearchParams, UnifiedSearchResult, UnifiedInstallOptions, UnifiedInstallResult, UnifiedInstalledSkill, SkillSource, SkillSourceInfo } from './types';
/**
 * Unified Skills API
 *
...
export declare const skills: {
     ...
     */
    readonly registry: UnifiedSkillRegistry;
    /**
     ...
     * ```
     */
    info(skillId: string): Promise<UnifiedSkillMetadata>;
    /**
     * Install a skill
     *
     ...
     * ```
     */
    list(): Promise<UnifiedInstalledSkill[]>;
    /**
