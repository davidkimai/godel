...
function getTemplates(framework) {
    if (!framework) {
        return exports.TEST_TEMPLATES;
    }
    return exports.TEST_TEMPLATES.filter(t => t.framework === framework);
}
/**
 * Get a specific template by name
 */
function getTemplate(name, framework) {
 ...
 */
function listTemplateNames(framework) {
...
function generateTest(options) {
    const fw = options.framework || 'jest';
 ...
 */
function generateTestSuite(targetDir) {
    const results = {
        success: true,
        files: [],
        errors: []
