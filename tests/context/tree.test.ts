...
describe('buildFileTree', () => {
  ...
  it('should handle metadata', () => {
    ...
    const tree = buildFileTree(['/src/main.ts'], metadata);
...
describe('formatTreeAsString', () => {
  it('should format tree as string', () => {
    const tree = buildFileTree(['/src/main.ts', '/src/utils.ts']);

    const output = formatTreeAsString(tree);
  ...
  it('should handle max depth', () => {
    ...
    const output = formatTreeAsString(tree, '', true, 1);
