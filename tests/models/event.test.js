...
describe('Event Model', () => {
    ...
    describe('createAgentStatusEvent Factory', () => {
        it('should create an agent status change event', () => {
            const event = (0, event_1.createAgentStatusEvent)('agent-123', 'pending', 'running');
        ...
        it('should create an agent status event with reason', () => {
            const event = (0, event_1.createAgentStatusEvent)('agent-456', 'running', 'failed', 'Resource exhaustion');
            const payload = event.payload;
    ...
    describe('createTaskStatusEvent Factory', () => {
        it('should create a task status change event', () => {
            const event = (0, event_1.createTaskStatusEvent)('task-123', 'pending', 'in_progress');
        ...
        it('should create a task status event with assignee', () => {
            const event = (0, event_1.createTaskStatusEvent)('task-456', 'pending', 'in_progress', 'agent-789');
            const payload = event.payload;
    ...
    describe('createQualityGateEvent Factory', () => {
        it('should create a passed quality gate event', () => {
            const event = (0, event_1.createQualityGateEvent)('task-123', 'agent-456', 'critique', 0.92, true, { correctness: 0.95, completeness: 0.88 });
        ...
        it('should create a failed quality gate event', () => {
            const event = (0, event_1.createQualityGateEvent)('task-789', 'agent-abc', 'test', 0.65, false, { correctness: 0.7, test_coverage: 0.6 });
    ...
    describe('createTestResultEvent Factory', () => {
        it('should create a test completed event', () => {
            const event = (0, event_1.createTestResultEvent)('agent-123', 100, 100, 0);
        ...
        it('should create a test failed event', () => {
            const event = (0, event_1.createTestResultEvent)('agent-456', 50, 48, 2);
        ...
        it('should create a test event with coverage', () => {
            ...
            const event = (0, event_1.createTestResultEvent)('agent-789', 30, 30, 0, coverage);
            const payload = event.payload;
    ...
    describe('createSafetyEvent Factory', () => {
        it('should create a boundary crossed event', () => {
            const event = (0, event_1.createSafetyEvent)('agent-123', 'delete /workspace/production_db', 'ethicsBoundaries', 'error', 'Attempted data destruction in protected area');
        ...
        it('should create an escalation required event for critical severity', () => {
            const event = (0, event_1.createSafetyEvent)('agent-456', 'recursive_file_modification', 'recursiveModification', 'critical', 'Agent exceeded recursive modification threshold');
