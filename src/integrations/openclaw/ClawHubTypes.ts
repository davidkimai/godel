 ...
 */
export class SkillAlreadyInstalledError extends ClawhubError {
  constructor(
    public slug: string,
    ...
    super(
      'SKILL_ALREADY_INSTALLED',
      `Skill ${slug}@${installedVersion} is already installed. Use --force to reinstall.`,
      { slug, installedVersion }
    );
 ...
 */
export class VersionNotFoundError extends ClawhubError {
  constructor(
    public slug: string,
    ...
    super(
      'VERSION_NOT_FOUND',
      `Version ${version} not found for skill ${slug}`,
      { slug, version, availableVersions }
    );
 ...
 */
export class DependencyError extends ClawhubError {
  constructor(
    public skill: string,
    ...
    super(
      'DEPENDENCY_ERROR',
      `Dependency error for ${skill}: ${dependency} - ${reason}`,
      { skill, dependency, reason }
    );
