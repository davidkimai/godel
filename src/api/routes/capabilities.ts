  ...
  fastify.get(
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      const capabilities = [
        ...
        {
          name: 'teams',
          description: 'Team orchestration management',
          version: '1.0.0',
          endpoints: [
            { method: 'GET', path: '/api/v1/teams', description: 'List all teams' },
            { method: 'POST', path: '/api/v1/teams', description: 'Create a new team' },
            { method: 'GET', path: '/api/v1/teams/:id', description: 'Get team details' },
            { method: 'PUT', path: '/api/v1/teams/:id', description: 'Update team' },
            { method: 'DELETE', path: '/api/v1/teams/:id', description: 'Delete team' },
            { method: 'POST', path: '/api/v1/teams/:id/start', description: 'Start team' },
            { method: 'POST', path: '/api/v1/teams/:id/stop', description: 'Stop team' },
            { method: 'POST', path: '/api/v1/teams/:id/pause', description: 'Pause team' },
            { method: 'POST', path: '/api/v1/teams/:id/resume', description: 'Resume team' },
            { method: 'POST', path: '/api/v1/teams/:id/scale', description: 'Scale team' },
            { method: 'GET', path: '/api/v1/teams/:id/events', description: 'Get team events' },
            { method: 'GET', path: '/api/v1/teams/:id/branches', description: 'List branches' },
            { method: 'POST', path: '/api/v1/teams/:id/branches', description: 'Create branch' },
            { method: 'POST', path: '/api/v1/teams/:id/switch-branch', description: 'Switch branch' },
          ],
        },
        {
          name: 'tasks',
